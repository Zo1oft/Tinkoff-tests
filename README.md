# Проект по автоматизации тестирования tinkoff.ru
<a href="https://www.tinkoff.ru/"><img width="30%" title="Tinkoff" src="images/logo/tinkoff.png"></a>
...
- Проверка работы страницы и кнопки открытия брокерского счета (c PageObjects)
- Проверка наличия Title на странице (работоспособности сайта)
- Проверка наличия ошибок в консоли

## :point_up_2: Сборка в Jenkins
### <a target="_blank" href="https://jenkins.autotests.cloud/job/Zoloft-Tinkoff-tests/">Сборка в Jenkins</a>
<p align="center">
